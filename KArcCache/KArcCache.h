#ifndef CACHE_PROJECT_KARCCACHE_H
#define CACHE_PROJECT_KARCCACHE_H
...
{
public:
    explicit KArcCache(size_t capacity = 10, size_t transformThrehold = 2)
        : capacity_(capacity)
...
#endif //CACHE_PROJECT_KARCCACHE_H
